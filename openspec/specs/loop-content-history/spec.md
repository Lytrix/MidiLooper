# loop-content-history

Loop persistence stores ordered immutable content records only. Load reconstructs current Loop
state and in-session undo depth from that content; undo/redo is not a persisted payload.
