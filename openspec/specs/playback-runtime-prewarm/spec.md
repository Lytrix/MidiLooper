...
Playback runtime objects SHALL be allocated during setup or state load so the first transport
tick does not trigger heap allocation. Shipped in **loop-ownership-hardening** (archived 2026-06-22);
audible-first prewarm scope updated in **unified-commit-lazy-slot-load**.
