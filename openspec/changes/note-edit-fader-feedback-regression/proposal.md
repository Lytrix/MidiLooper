...
- **§7.24 (2026-07-02):** Inbound F1 honors `selectFaderFeedbackIgnoreUntilMs_`; geometry motor echo guard (D38–D40). §7.24.8: user F1 select during geometry edit allowed (echo window only).
