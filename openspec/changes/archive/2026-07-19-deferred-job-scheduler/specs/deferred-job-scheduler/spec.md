...
- **THEN** button triggers remain 1:1 with presses (no progressive starve)
- **AND** `#CAP,LLBG,parse_us` does not reintroduce ~295ms PSRAM-stats clusters (baseline [`230145`](../../../../captures/session_20260718_230145.log))
