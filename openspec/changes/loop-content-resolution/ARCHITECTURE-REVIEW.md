...
| **Phase scope** | Sparse `soundingAt`, split `prepareRebuildSpans`, >63-bar measure ([`151450`](../../../captures/session_20260815_151450.log) 139 bars); IndexCommit / pairing / reconstruct / project / RebuildSpans / RebuildPrepare batch `kDeviceGateEventsPerSlice`; 5.15 **complete**; 5.16c `prep` slice; **5.17 complete**; **5.7c FROZEN** [`170024`](../../../captures/session_20260815_170024.log); derived-index storage invariant on DEC-037 (not a new DEC); **5.18** pair design only; **no** delete of materialize; arm cap stays off |
