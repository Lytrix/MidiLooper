...
| **Phase scope** | Sparse `soundingAt`, split `prepareRebuildSpans`, >63-bar measure ([`141630`](../../../captures/session_20260815_141630.log) 139 bars); IndexCommit / pairing / reconstruct / project / RebuildSpans batch `kDeviceGateEventsPerSlice`; phase telemetry; **no** delete of materialize; arm cap stays off |
