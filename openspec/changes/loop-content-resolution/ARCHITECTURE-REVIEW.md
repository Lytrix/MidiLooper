...
| **Phase scope** | **6A PASS** [`185931`](../../../captures/session_20260815_185931.log) `match=1`. **6B PASS** [`192334`](../../../captures/session_20260815_192334.log) `stale_range` `dcnt` 15/5/5. **6C** overdub source from prepared LCR. Score 6C vs 3b **2214 µs** |
