...
- [ ] 5.7 Measure selected-loop idle gate on a loop **>63 bars**: `DIAG,lcr` or explicit skip; no `idle_maint` ~50 ms; no 1 s `DFRAME` gaps. Size **PASS**. 5.17d **PASS**. 5.7a reserve **PASS** [`163942`](../../../captures/session_20260815_163942.log). **5.7b device FAIL** [`164922`](../../../captures/session_20260815_164922.log) `loop_rem,idle_maint,14744010` on first `spans` slice (`channelByNoteId` PSRAM `emplace`). After fill, `spans` 1000 notes/s flat.
