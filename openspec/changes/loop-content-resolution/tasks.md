...
- [ ] 6C Prepared LCR range → `overdubSourceView`. Native landed. Device [`194015`](../../../captures/session_20260815_194015.log): **consume not exercised** (no `DIAG,lcr,6c`, no `DIAG,lcr,mat=`). 3b fallback `begin_capture` **3612 / 6464 / 8076 / 8618 µs**. Recapture: STOPPED until `DIAG,lcr,mat=`, then PLAYING overdub. Score against **2214 µs**.
