...
- [ ] 5.7 Measure selected-loop idle gate on a loop **>63 bars**: `DIAG,lcr` or explicit skip; no `idle_maint` ~50 ms; no 1 s `DFRAME` gaps. Size accepted. [`134505`](../../../captures/session_20260815_134505.log)+[`134954`](../../../captures/session_20260815_134954.log) complete `hist=2394` `reb=100560282`; pairing PASS; reconstruct was one **1.04 s** slice. Re-measure after 5.13.
