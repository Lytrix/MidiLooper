...
- [ ] 5.7 Measure selected-loop idle gate on a loop **>63 bars**: `DIAG,lcr` or explicit skip; no `idle_maint` ~50 ms; no 1 s `DFRAME` gaps. Size accepted. [`132945`](../../../captures/session_20260815_132945.log) 139 bars / 2393 notes: complete `hist=2394` `reb=100534361`; latency **FAIL** — `pairCapturePassNotes` of pass 0 (4400 events) was one slice (`idle_maint` 27.45 s, `midi_gap` 27.48 s, `DFRAME` silent 31 s). Re-measure after 5.12.
