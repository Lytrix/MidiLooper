...
- [ ] 6C Prepared LCR range → `overdubSourceView`. Native landed. [`194643`](../../../captures/session_20260815_194643.log): `DIAG,lcr,mat=` `hist=2614` `walk=0`, `6a` `match=1`; `DIAG,lcr,6c` / `begin_capture` lost to `RING,overflow`. INFO open **42 ms** (prepared-ready) then **9 ms** (post-commit 3b). Recapture: overdub+stop within ~1 s. Score against **2214 µs**. [`194015`](../../../captures/session_20260815_194015.log) was pre-complete (3b 3612–8618 µs).
- [ ] After 6C — investigate MIDI Input Gap > 50 ms in [`192334`](../../../captures/session_20260815_192334.log): `DIAG,midi_gap` **135 / 119 / 138 ms** at 54.7 / 64.7 / 69.8 s while `clockrate` stayed **47**. Not a 6B fail (`clockrate` held through OVERDUB and PLAYING after stop). Do not start during 6C. Do not treat as RC-J (that is post-STOPPED 48→24→0).
