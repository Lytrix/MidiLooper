...
- [ ] 5.2 Overdub entry remains cheap (3b copy); no `VCACHE,full` on the normal path; no full materialize after commit. **FAIL** [`175544`](../../../captures/session_20260815_175544.log) `begin_capture` **108979 µs**. **3b restore native** (copy `visualCache.notes`; no `markDisplayCachesStale` on `startOverdubbing`). Host 1195/1195. Device recapture after flash — bar < 50 ms vs 3b [`045556`](../../../captures/session_20260814_045556.log) 2214 µs. Do not wire LCR onto overdub. No Stage 6.
