...
- `pair` `DFRAME` 1.273 s [`172927`](../../../captures/session_20260815_172927.log) — **5.18a**: `byNoteId` (`bn=5.346 s`). **5.18b native:** last-wins flat `byNoteId`; device remasure next. `openOnByPitch` retained. Not 5.7c.
