...
- **AND** IndexCommit, `pairCapturePassNotes`, reconstruct span build, and RebuildSpans MUST process at most `kDeviceGateEventsPerSlice` events or spans per idle slice
