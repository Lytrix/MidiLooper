# Delta spec — overlap hidden note select (consumer contract)

**Change:** `overlap-hidden-note-select`  
**Capability:** `overlap-hidden-note-select`  
**Parent:** [note-edit-modification-session](../note-edit-modification-session/specs/note-edit-modification-session/spec.md)  
