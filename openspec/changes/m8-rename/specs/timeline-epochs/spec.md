...
- FROM: `### Requirement: Published events live in active epochs`
- TO: `### Requirement: Published events live in active takes`

- FROM: `### Requirement: Record stop seals capture into an epoch`
- TO: `### Requirement: Record stop commits capture into a take`
