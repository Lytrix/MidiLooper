...
NOTE_EDIT_MEM bool applyPitchChange(Track& track, EditManager& manager,
    ...
    // Merge suffix-adjacent same-target-pitch notes into the moving note end before the geometry
    // pipeline. Skip inner overlap notes inside the moving note range.
