...
**Status:** Not implemented. Depends on **Phase 1** (jam state) and **Phase 2** (`jamTick` / `getEffectivePlaybackTick`) — both done.  
...
- **Requirement when implemented:** Document which mode owns the fader map and how it interacts with [`FADER_STATE_SYSTEM.md`](../docs/FADER_STATE_SYSTEM.md) patterns.
