...
- [ ] `docs/00-authority/PROJECT_INTENT.md`
- [ ] `docs/00-authority/ARCHITECTURE_RULES.md`
- [ ] `docs/00-authority/DELIVERY_RULES.md` (if OpenSpec / timeline / persistence)
...
Per [00-authority/README.md](../00-authority/README.md#conflict-resolution):
