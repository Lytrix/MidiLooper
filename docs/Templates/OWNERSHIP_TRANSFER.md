...
Required when **mutable scope** moves from one module to another. Pair with [ARCHITECTURE_REASSESSMENT.md](../ARCHITECTURE_REASSESSMENT.md) and [ARCHITECTURE_RULES.md](../Authority/ARCHITECTURE_RULES.md#ownership-transfer-protocol).
...
- [ ] Authority conflict check ([README.md](../Authority/README.md#conflict-resolution))
