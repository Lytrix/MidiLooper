...
**Mandatory before firmware implementation** when a [formal trigger](../ARCHITECTURE_REASSESSMENT.md#formal-triggers) fired. For normal extension work: quick `rg` on DECISION_LOG, then implement per [decision ladder](../Authority/ARCHITECTURE_RULES.md#progress-bias-and-decision-ladder).
