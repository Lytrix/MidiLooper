...
- **Overdub participant discovery:** `feature/overdub-participant-discovery` — occupy clock same-tick Off-before-On ([`overdub_occupy_clock_same_tick_off_before_on_bugfix.md`](../Plans/overdub_occupy_clock_same_tick_off_before_on_bugfix.md)); parent catch-up HITL FAIL [`235314`](../../captures/session_20260818_235314.log) (4 `n=0 a=1`); USB `playMidiEvents` catch-up HITL FAIL [`214856`](../../captures/session_20260818_214856.log) reverted; wrap-S HITL PASS; loop-head storage-0 HITL PASS [`203948`](../../captures/session_20260818_203948.log) — [CURRENT_WORK.md](CURRENT_WORK.md)
