...
**Active work:** **DEC-038 038.1 HITL** — issue 1 + issue 2 shipped (native). Device HITL next. Issue 3 parked (wrap-on-clock). Fixtures [`231206`](../captures/session_20260815_231206.log) / [`232914`](../captures/session_20260815_232914.log). Not 038.2. **6D.4 restamp holds** [`210508`](../captures/session_20260815_210508.log). Not all of LCR live.
