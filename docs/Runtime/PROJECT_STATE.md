...
**Active work:** **DEC-037** `LoopContentResolution` — **6C native** (`tryResolvePreparedWindow` → `overdubSourceView`; 3b copy fallback). Device score next vs 3b **2214 µs**. **6B PASS** [`192334`](../../captures/session_20260815_192334.log) `stale_range` `dcnt` 15/5/5. After 6C device: MIDI Input Gap > 50 ms in that capture (`midi_gap` 135 / 119 / 138 ms, `clockrate` 47). **6A PASS** [`185931`](../../captures/session_20260815_185931.log) `match=1`. **5.1 PASS** [`173842`](../../captures/session_20260815_173842.log). **5.2 PASS** [`180624`](../../captures/session_20260815_180624.log) `begin_capture` 10050 µs. Layer D 3b overdub entry **PASS** [`045556`](../../captures/session_20260814_045556.log) `begin_capture` 2214 µs; undo [`112909`](../../captures/session_20260814_112909.log) 3 ms, no `VCACHE,full`.
