...
- **Overdub participant discovery:** `feature/overdub-participant-discovery` — wrap-S HITL PASS; loop-head wrap-seal native PASS ([`overdub_loop_head_playback_ledger_bugfix.md`](../Plans/overdub_loop_head_playback_ledger_bugfix.md)) — [CURRENT_WORK.md](CURRENT_WORK.md)
...
- **Next product slice:** loop-head wrap-seal HITL — [`overdub_loop_head_playback_ledger_bugfix.md`](../Plans/overdub_loop_head_playback_ledger_bugfix.md)
