...
**Active work:** **DEC-037** `LoopContentResolution` — **6A firmware** (keep `TickIndex` after idle gate; visual-cache slice consumes `resolveWindow` when stamp matches; old gather stays oracle). Device `DIAG,lcr,6a` measure owed. Do not start 6B/6C. **5.1 PASS** [`173842`](../../captures/session_20260815_173842.log). **5.2 PASS** [`180624`](../../captures/session_20260815_180624.log) `begin_capture` 10050 µs. Layer D 3b overdub entry **PASS** [`045556`](../../captures/session_20260814_045556.log) `begin_capture` 2214 µs; undo [`112909`](../../captures/session_20260814_112909.log) 3 ms, no `VCACHE,full`.
