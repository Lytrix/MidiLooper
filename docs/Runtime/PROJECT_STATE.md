...
- **Overdub participant discovery:** `feature/overdub-participant-discovery` — occupy on-tick ledger catch-up native shipped, HITL pending [`231038`](../../captures/session_20260818_231038.log); USB `playMidiEvents` catch-up HITL FAIL [`214856`](../../captures/session_20260818_214856.log) reverted; wrap-S HITL PASS; loop-head storage-0 HITL PASS [`203948`](../../captures/session_20260818_203948.log) — [CURRENT_WORK.md](CURRENT_WORK.md)
