...
**`feature/overdub-participant-discovery`** — source-view resolver geometry: **investigation approved**; Gates 1–4 pinned; **Gate 5A shipped** (`findNoteOffForOnIndex` equal-tick Off-before-On, not a full tick sort); **Gate 5B** Length `6073` 551 provenance **not** implementation-ready ([`overdub_occupy_source_view_keeps_resolver_geometry_bugfix.md`](../Plans/overdub_occupy_source_view_keeps_resolver_geometry_bugfix.md); pin [`121141`](../../captures/session_20260819_121141.log) L2324 `6079 144–168` → L3298 `144–360`). Leftover identity HITL **PASS** [`111819`](../../captures/session_20260819_111819.log); missing-open 5893-class HITL **MET** [`121141`](../../captures/session_20260819_121141.log); remaining `n=1 a=2` extras have `on=1` — identity RC **STOP** ([`overdub_occupy_missing_open_identity_bugfix.md`](../Plans/overdub_occupy_missing_open_identity_bugfix.md)). Leftover pin [`104654`](../../captures/session_20260819_104654.log) `n=1 a=0` 19 → 0. [DEC-041](../DECISION_LOG.md#dec-041-occupy-present-at-s-jit-not-full-loop-lcr-mat): occupy reads `Entry.noteId`. Clock equal-tick Off-before-On HITL **PASS** [`001021`](../../captures/session_20260819_001021.log) ([`overdub_occupy_clock_same_tick_off_before_on_bugfix.md`](../Plans/overdub_occupy_clock_same_tick_off_before_on_bugfix.md); `n=0 a=1` = 0; `n=1 a=0` = 0). Parent catch-up pin [`235314`](../../captures/session_20260818_235314.log) was 4. Pin [`233247`](../../captures/session_20260818_233247.log) was 11. Interval catch-up in tree ([`overdub_occupy_on_tick_clock_catchup_bugfix.md`](../Plans/overdub_occupy_on_tick_clock_catchup_bugfix.md)). Playback `mergedMidiEvents` is committed-only (**FROZEN** leftover `n=1 a=0` met). Pin [`224719`](../../captures/session_20260818_224719.log). Wrap-S ledger catch-up HITL **PASS** [`185831`](../../captures/session_20260818_185831.log) ([`overdub_wrap_committed_pass_playback_bugfix.md`](../Plans/overdub_wrap_committed_pass_playback_bugfix.md)). Loop-head storage-0 occupy HITL **PASS** [`203948`](../../captures/session_20260818_203948.log) ([`overdub_loop_head_playback_ledger_bugfix.md`](../Plans/overdub_loop_head_playback_ledger_bugfix.md)). Parent wrap-rebuild **FROZEN**. USB occupy `playMidiEvents` catch-up HITL **FAIL** [`214856`](../../captures/session_20260818_214856.log) **reverted**. `playCommittedLoopMidi` writes committed-only `mergedMidiEvents` via `applyPlaybackLedgerEvent` before `sendMidiEvent` may emit. `evaluateOccupyOverlap` parked. Stage 1c dirty/save stall shipped; Stage 1 `from=span` HITL **parked**. Do not wait STOPPED for 64-bar `lcr,mat`. Phase 4 1-bar HITL **PASS** ([`123803`](../../captures/session_20260818_123803.log)). PR pending → `dev`.
