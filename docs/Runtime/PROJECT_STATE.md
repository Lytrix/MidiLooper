...
Last updated: 2026-08-12 (S0c firmware; device attribution pending vs session_20260812_193645)

---

## Current branch

**Active work:** **S0c** — split `usbdev` into `usbread` / `usbdisp` / `usbcap` / `usbthru` (observation only); device attribution pending. Architecture [`runtime_scheduling_admission_model_architecture.md`](../Plans/runtime_scheduling_admission_model_architecture.md) §31j. Baseline [`193645`](../../captures/session_20260812_193645.log). Do not start S1 / admission / RC-J.
