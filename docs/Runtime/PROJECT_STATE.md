...
**`feature/overdub-participant-discovery`** — [DEC-041](../DECISION_LOG.md#dec-041-occupy-present-at-s-jit-not-full-loop-lcr-mat): occupy reads `Entry.noteId`. Capture emit does not write occupy’s ledger ([`overdub_occupy_capture_stream_ledger_bugfix.md`](../Plans/overdub_occupy_capture_stream_ledger_bugfix.md); pin [`221334`](../../captures/session_20260818_221334.log)). Wrap-S ledger catch-up HITL **PASS** [`185831`](../../captures/session_20260818_185831.log) ([`overdub_wrap_committed_pass_playback_bugfix.md`](../Plans/overdub_wrap_committed_pass_playback_bugfix.md)). Loop-head storage-0 occupy HITL **PASS** [`203948`](../../captures/session_20260818_203948.log) ([`overdub_loop_head_playback_ledger_bugfix.md`](../Plans/overdub_loop_head_playback_ledger_bugfix.md)). Parent wrap-rebuild **FROZEN**. USB occupy `playMidiEvents` catch-up HITL **FAIL** [`214856`](../../captures/session_20260818_214856.log) **reverted**. `playCommittedLoopMidi` writes merged via `applyPlaybackLedgerEvent` before `sendMidiEvent` may emit. `evaluateOccupyOverlap` parked. Stage 1c dirty/save stall shipped; Stage 1 `from=span` HITL **parked**. Do not wait STOPPED for 64-bar `lcr,mat`. Phase 4 1-bar HITL **PASS** ([`123803`](../../captures/session_20260818_123803.log)). PR pending → `dev`.
...
- **Overdub participant discovery:** `feature/overdub-participant-discovery` — occupy capture-stream ledger native shipped (pin [`221334`](../../captures/session_20260818_221334.log)); USB catch-up HITL FAIL [`214856`](../../captures/session_20260818_214856.log) reverted; wrap-S HITL PASS; loop-head storage-0 HITL PASS [`203948`](../../captures/session_20260818_203948.log) — [CURRENT_WORK.md](CURRENT_WORK.md)
