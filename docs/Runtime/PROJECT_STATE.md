...
**Active work:** **DEC-037** `LoopContentResolution` — derived-index storage invariant recorded (not a new DEC). 5.15 / 5.17 / **5.7c device PASS** [`170024`](../../captures/session_20260815_170024.log). **5.7 leftover:** `pair` `DFRAME` 1.277 s. Plan [`loop_content_resolution_spans_dframe_gap_refinement.md`](../Plans/loop_content_resolution_spans_dframe_gap_refinement.md). Layer D 3b overdub entry **PASS** [`045556`](../../captures/session_20260814_045556.log) `begin_capture` 2214 µs; undo [`112909`](../../captures/session_20260814_112909.log) 3 ms, no `VCACHE,full`.
