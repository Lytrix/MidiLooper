...
Last updated: 2026-08-15 (DEC-038 038.1 landed)
...
**Active work:** **DEC-038 038.1 HITL** — issue 1 + issue 2 LCR shipped. Playback silence gated to committed wrap undo. Stopped slot select/record/play is single-slot ([`000149`](../captures/session_20260816_000149.log)). Queued short-press switch replaces the enabled set ([`002545`](../captures/session_20260816_002545.log)). Issue 3 parked. Not 038.2. **6D.4 restamp holds** [`210508`](../captures/session_20260815_210508.log). Not all of LCR live.
