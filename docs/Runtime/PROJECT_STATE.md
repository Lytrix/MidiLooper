...
- **Overdub participant discovery:** `feature/overdub-participant-discovery` — occupy `n=0 a=1` off tick 0 display follow-up; wrap-S HITL PASS; loop-head storage-0 HITL PASS [`203948`](../../captures/session_20260818_203948.log) — [CURRENT_WORK.md](CURRENT_WORK.md)
