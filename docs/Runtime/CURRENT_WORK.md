...
**Open — garbled display** at ~bar 40 of the second overdub. Unattributed: no reset, frames painted at 23.6 fps (DFRAME index +750 across the gap), resolve max 6 995 µs, `AllocatorFailure` 0, RC-G mask inactive at that point.
