...
| HITL catalog / quarantine → `StorageManagerHitlSerial.cpp` | **Done** (2026-08-08) — build SUCCESS; native 969/969; **uncommitted** |
| `readCurrentSetFilePreamble` / `Epilogue` | Next candidate |
| Deferred-save status queries | Optional / park after next slice |
