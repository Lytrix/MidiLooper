...
**Gate 0:** `OverlapNoteIdSet` fixed capacity 128; overflow does not grow. Native PASS. Idle one-shot `#CAP,DIAG,stored_notes,track,…,slot,…,notes,…,unique,…,max_same_pitch,…` from a clean visual cache (not a `SEVT` dump; not gated on Committed overdub). Device count still owed after upload. [`150917`](../../captures/session_20260813_150917.log) had no line because the emitter did not exist and the overdub was `Skipped`.
