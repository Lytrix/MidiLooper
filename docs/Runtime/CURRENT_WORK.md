...
**Now:** **Overdub live wrap continuation off** — held notes close to the playhead only; no tail-to-loop-end after session wrap. Tick-0 head gate reverted (`fb0cbb0`). Evidence [`012925`](../../captures/session_20260816_012925.log) note 30 @ 2880. **038.1 live +1 HITL PASS** [`011413`](../../captures/session_20260816_011413.log). **038.2 landed.** Issue 3 parked. Do not start midi_gap / 6.3 until asked.
