...
Last updated: 2026-08-13 (NOTE_EDIT display Stage 1)
...
**NOTE_EDIT / LOOP_EDIT display split (Stage 1 shipped):** [`171219`](../../captures/session_20260813_171219.log) LOOP_EDIT `visualCache` 68 vs NOTE_EDIT paint 23. Shared committed list is `visualCache.notes`; current-state overlay only. Plan: [`note_edit_visual_cache_display_unification_refinement.md`](../Plans/note_edit_visual_cache_display_unification_refinement.md). Stage 1: missing current-state row is not Hidden (`isRowHiddenOrDeleted`). Next: Stage 2 visual-cache committed base. Do not use `visualCache` as the overdub overlap source.
