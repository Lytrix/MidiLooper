...
**Shipped:** TrackManager PR [#22](https://github.com/Lytrix/MidiLooper/pull/22), NoteMovementUtils PR [#23](https://github.com/Lytrix/MidiLooper/pull/23), DisplayNoteResolve PR [#24](https://github.com/Lytrix/MidiLooper/pull/24), NoteEditFocus header PR [#25](https://github.com/Lytrix/MidiLooper/pull/25). **Next:** confirm #18 close / Phase LR shim cleanup optional.
