...
**RC-E fix shipped:** overdub-stop adopt now marks only adopted bars clean (`Loop::adoptComposedDisplayNotesFromViewport`); idle slices backfill the rest. Mixed-cache refill drops the ±20-bar neighborhood cap. Device verify pending.
