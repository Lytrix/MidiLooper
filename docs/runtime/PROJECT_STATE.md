...
Last updated: 2026-07-18 (Phase B.1 DeferredJobScheduler; lazy-slot-load archived)

---

## Current branch

**`feature/deferred-lazy-load`** — OpenSpec [`deferred-job-scheduler`](../../openspec/changes/deferred-job-scheduler/) Phase B.1. Phase A archived `2026-07-18-unified-commit-lazy-slot-load`. See [CURRENT_WORK.md](CURRENT_WORK.md).
