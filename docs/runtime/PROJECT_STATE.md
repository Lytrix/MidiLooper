...
**Active work:** **note-edit resolver contracts** — Stage 8 display projection (8.1 sidebar shipped; 8.2 fader/snapshot next). Plan: [`note_edit_resolver_authority_contracts_refinement.md`](../plans/note_edit_resolver_authority_contracts_refinement.md). Parallel: **note-edit-current-state** archive prep — see [CURRENT_WORK.md](CURRENT_WORK.md).
