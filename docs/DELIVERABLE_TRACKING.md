...
**Next (persistence/runtime):** DEC-037 **LoopContentResolution prototype** — **6C native** (prepared LCR → `overdubSourceView`; 3b copy fallback). Device score next vs 3b [`045556`](../captures/session_20260814_045556.log) **2214 µs**. **6B PASS** [`192334`](../captures/session_20260815_192334.log). **6A PASS** [`185931`](../captures/session_20260815_185931.log) `match=1`. No `openOnByPitch` flatten / B. Overlay track A parked.
