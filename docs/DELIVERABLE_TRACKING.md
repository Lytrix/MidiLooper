...
**Next (persistence/runtime):** DEC-037 **LoopContentResolution prototype** — **6D.4 architecture approved; firmware not authorized.** 6D.3/6D.2 native PASS; 6D.1 FAIL. 6C consume-when-ready. **6B PASS** [`192334`](../captures/session_20260815_192334.log). **6A PASS** [`185931`](../captures/session_20260815_185931.log) `match=1`. No `openOnByPitch` flatten / B. Overlay track A parked.
