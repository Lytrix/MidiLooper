...
**Next (persistence/runtime):** **`feature/overdub-participant-discovery`** — overdub participant Phase 4 **in tree** (note-off fill skip when source view covers the loop; device HITL open). Phase 3 1-bar occupy **PASS** [`121933`](../captures/session_20260818_121933.log); 64-bar occupy identity **parked** [`122848`](../captures/session_20260818_122848.log). Phase 2 **closed** [`040236`](../captures/session_20260818_040236.log); PLAYING/STOPPED/MUTED HITL skipped ([DEC-040](DECISION_LOG.md#dec-040-skip-playingstoppedmuted-overdub-participant-hitl)). Native 1333/1333. Parent [`overdub_participant_loop_content_architecture.md`](Plans/overdub_participant_loop_content_architecture.md). Loop length during overdub queued. **NOTE_EDIT hydrate** queued. **Playback gather** Stage 1 hooks. Overlay track A parked.
