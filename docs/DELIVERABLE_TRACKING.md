...
**Next (persistence/runtime):** **`feature/overdub-participant-discovery`** (36 commits, PR pending → `dev`) — overdub participant Phase 2 **closed** [`040236`](../captures/session_20260818_040236.log); PLAYING/STOPPED/MUTED HITL skipped ([DEC-040](DECISION_LOG.md#dec-040-skip-playingstoppedmuted-overdub-participant-hitl)); **Phase 3** fill disable next (firmware not started). Span membership bugfix **FROZEN** [`overdub_participant_source_view_span_membership_bugfix.md`](Plans/overdub_participant_source_view_span_membership_bugfix.md). Parent [`overdub_participant_loop_content_architecture.md`](Plans/overdub_participant_loop_content_architecture.md). Wrap-crossing hold consume HITL **PASS** [`155450`](../captures/session_20260817_155450.log) (`e1f57c5`). Display undo/wrap/pitch-move RC-W1/U1 PASS [`152627`](../captures/session_20260817_152627.log). Overdub occupied-lane RC11/RC12 **FROZEN** [`140355`](../captures/session_20260817_140355.log). Loop length during overdub queued. **NOTE_EDIT hydrate** queued. **Playback gather** Stage 1 hooks (native 1329/1329). Overlay track A parked.
