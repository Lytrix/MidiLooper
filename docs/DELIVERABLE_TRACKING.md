...
**Next (persistence/runtime):** DEC-037 **LoopContentResolution prototype** — **6D investigation** (incremental post-commit index + checkpoint maintenance; A/B rejected). 6C consume-when-ready native landed. **6B PASS** [`192334`](../captures/session_20260815_192334.log). **6A PASS** [`185931`](../captures/session_20260815_185931.log) `match=1`. No `openOnByPitch` flatten / B. Overlay track A parked.
