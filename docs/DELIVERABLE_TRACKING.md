...
**Next (persistence/runtime):** **Overdub wrap keeps head-off wrap-held pair** native (HITL open on [`014937`](../captures/session_20260816_014937.log) note 12 ON@2976 / OFF@96). **DEC-038 038.1 live +1 HITL PASS** [`011413`](../captures/session_20260816_011413.log). **038.2 landed** (one `OverdubPassAdded` `passIds` + STK3). **038.1 HITL PASS** [`004842`](../captures/session_20260816_004842.log). Native **6E.1–6E.5 PASS**. **6D.4 landed.** Not all of LCR live. 6C consume-when-ready. **6B PASS** [`192334`](../captures/session_20260815_192334.log). **6A PASS** [`185931`](../captures/session_20260815_185931.log) `match=1`. No `openOnByPitch` flatten / B. Overlay track A parked.
