...
**Next (persistence/runtime):** **`feature/overdub-participant-discovery`** — occupy capture-stream ledger ([`overdub_occupy_capture_stream_ledger_bugfix.md`](Plans/overdub_occupy_capture_stream_ledger_bugfix.md); pin [`221334`](../captures/session_20260818_221334.log)); USB catch-up HITL **FAIL** [`214856`](../captures/session_20260818_214856.log) (`playMidiEvents` from occupy reverted); wrap-S HITL **PASS** [`185831`](../captures/session_20260818_185831.log); loop-head storage-0 HITL **PASS** [`203948`](../captures/session_20260818_203948.log) ([`overdub_loop_head_playback_ledger_bugfix.md`](Plans/overdub_loop_head_playback_ledger_bugfix.md)). Occupy lookup of `Entry.noteId` shipped. Stage 1 `from=span` HITL **parked**. Do not wait STOPPED for 64-bar `lcr,mat`. Phase 4 1-bar HITL **PASS** [`123803`](../captures/session_20260818_123803.log). Loop length during overdub queued. **NOTE_EDIT hydrate** queued. **Playback gather** Stage 1 hooks. Overlay track A parked.
