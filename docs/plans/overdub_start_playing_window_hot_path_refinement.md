...
**Architecture:** [RuntimeArchitecture.md](../00-authority/Architecture/RuntimeArchitecture.md), [Display.md](../00-authority/Architecture/Display.md)
...
Keep PLAYING and overdub arm off full-loop **display representation** rebuild; align with deferred scheduling responsibilities in [DerivedViews.md](../00-authority/Architecture/DerivedViews.md).
