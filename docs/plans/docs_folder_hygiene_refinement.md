...
**Status:** Proposed — **Phase 1 Done** (2026-08-08)  
...
- `docs/Architecture/` (1 file) sits beside `docs/00-authority/Architecture/` (6 files).
...
| Keep authority docs under `00-authority/` | Leave competing authority trees |
...
- `docs/runtime/CURRENT_WORK.md` = **what should be worked on now**.
...
- `00-authority/` — authoritative architecture/contracts
...
`docs/00-authority/Architecture/HITL_ARCHITECTURE.md`
...
1. **Phase 1** — low-risk navigation and authority clarification.
2. **Phase 2a** — historical Cursor exports.
3. **Phase 2b–2d** — archive handoffs, bugfixes, and refinements as lifecycle is clear.
4. **Phase 3** — only if confusion remains.

Do not combine Phase 1 with large-scale archival in a single change.
...
- `docs/README.md` clearly explains where authority, current work, guides, and plans live.
...
- `docs/00-authority/` is the unambiguous authority tree.
