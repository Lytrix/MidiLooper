...
| Process, guards, verification | [DELIVERY_RULES.md](../00-authority/DELIVERY_RULES.md) |
...
From `~/.cursor/plans/timeline_data_model_refactor_9cbaeb60.plan.md` §1. Do not reorder without project decision. Detail: [DELIVERY_RULES.md](../00-authority/DELIVERY_RULES.md).
...
| Layer | Role |
|-------|------|
| [00-authority/](../00-authority/README.md) | Intent → architecture → delivery (wins over plans) |
