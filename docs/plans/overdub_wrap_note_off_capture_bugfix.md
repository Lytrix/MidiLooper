...
These are architectural rules, not implementation details. Add to [`docs/Guides/LOOP_MIDI_STORAGE_AND_VALIDATION.md`](docs/Guides/LOOP_MIDI_STORAGE_AND_VALIDATION.md) and [`docs/00-authority/Architecture/Playback.md`](docs/00-authority/Architecture/Playback.md) in the docs phase.
...
- [`docs/00-authority/Architecture/Playback.md`](docs/00-authority/Architecture/Playback.md) — Invariant 1 (playback read-only)
