...
- [`docs/Authority/Architecture/RuntimeArchitecture.md`](../Authority/Architecture/RuntimeArchitecture.md) — runtime layers (storage → representations → interval → consumers)
