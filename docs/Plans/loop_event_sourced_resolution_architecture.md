...
**Status:** Active — native Stages 0–6 PASS; production MIDI/display stay on materialize until three gates pass  
**Date:** 2026-08-14  
...
| 7 | In-RAM checkpoints at `checkpointIntervalTicks`; `resolveState` from checkpoint + tail | DEC-035 D3 *shape*; not persisted yet |
| 8 | Loop switch at a high tick — bounded replay distance, never from 0 | `resolveState` is required here |
