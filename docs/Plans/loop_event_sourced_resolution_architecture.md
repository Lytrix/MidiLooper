...
| 9 | Device three-part gate on `035414` class — native µs recorded; short-loop sliced `lcr` PASS [`225744`](../captures/session_20260814_225744.log); per-bar `soundingAt` FAIL [`225351`](../captures/session_20260814_225351.log). Size probe **>63 bars** accepted [`115750`](../captures/session_20260815_115750.log) (139 bars). [`122259`](../captures/session_20260815_122259.log) finalized (`reb=100533678`). 5.11 batches 8 events/spans per slice + phase telemetry. Re-measure 5.7; arm cap stays off | keep 3b copy path until this wins |
