...
**Status:** Native **PASS** 1374/1374. HITL [`121141`](../../captures/session_20260819_121141.log): **5893-class MET**. Successor [`overdub_occupy_source_view_keeps_resolver_geometry_bugfix.md`](overdub_occupy_source_view_keeps_resolver_geometry_bugfix.md) **FROZEN** — closed via 5A + sibling D2-D [`174246`](../../captures/session_20260819_174246.log).  
**Date:** 2026-08-19  
**Kind:** bugfix  
