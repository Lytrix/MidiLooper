...
**Date:** 2026-08-06  
**Status:** Investigation complete; policy shipped in [`docs/Authority/NAMING.md`](../Authority/NAMING.md)  
...
**Not** a repository-wide rename. Apply [NAMING.md](../Authority/NAMING.md) § Note geometry — boundary **NoteGeometry**, concise implementation inside owners.
...
- Created [`docs/Authority/NAMING.md`](../Authority/NAMING.md) as canonical policy
- Slimmed `.cursor/rules/Naming-Vocabulary-Teensy-Looper.mdc` to pointer + agent enforcement
- Updated authority hierarchy in `docs/Authority/README.md`
