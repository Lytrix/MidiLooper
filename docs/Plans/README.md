...
| [overdub_occupy_on_tick_clock_catchup_bugfix.md](overdub_occupy_on_tick_clock_catchup_bugfix.md) | USB occupy ledger catch-up `(lastTick, occupyPhase]`; no playback advance; HITL pending vs [`231038`](../../captures/session_20260818_231038.log) 6 `n=0 a=1` |
