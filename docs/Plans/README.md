...
| [overdub_occupy_catchup_open_note_stack_bugfix.md](overdub_occupy_catchup_open_note_stack_bugfix.md) | Catch-up per-phase Off then On so stack Ons in `(lastTick, occupy]` can close; pin [`095902`](../../captures/session_20260819_095902.log) |
