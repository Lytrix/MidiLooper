...
| [overdub_occupy_merged_capture_ledger_bugfix.md](overdub_occupy_merged_capture_ledger_bugfix.md) | Playback `mergedMidiEvents` is committed-only; HITL **FAIL** [`231038`](../../captures/session_20260818_231038.log) (`n=1 a=0` met; 6 `n=0 a=1`) |
