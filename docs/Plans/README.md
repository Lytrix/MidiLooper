...
| [runtime_scheduling_admission_model_architecture.md](runtime_scheduling_admission_model_architecture.md) | Runtime timing-envelope contract (interval reservation deferred) |
