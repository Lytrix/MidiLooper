...
| [overdub_occupy_leftover_identity_bugfix.md](overdub_occupy_leftover_identity_bugfix.md) | Leftover Entry whose On is gone from committed stream; pin [`104654`](../../captures/session_20260819_104654.log) `lid=5701`; native shipped, HITL gate open |
