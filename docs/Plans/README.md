...
| [overdub_occupy_capture_stream_ledger_bugfix.md](overdub_occupy_capture_stream_ledger_bugfix.md) | Capture emit does not write occupy’s ledger; pin [`221334`](../../captures/session_20260818_221334.log) |
