...
| [overdub_participant_loop_content_architecture.md](overdub_participant_loop_content_architecture.md) | Notes present at tick `S`; `PresentNote` C++ type; NOTE_EDIT overlap sibling; Phase 1 + companion publish HITL; Phase 2a session-undo inverse planned; hydrate firmware not authorized |
