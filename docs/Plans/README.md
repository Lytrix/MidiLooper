...
| [overdub_consume_id_resolution_completeness_bugfix.md](overdub_consume_id_resolution_completeness_bugfix.md) | **Shipped** — Stages 1–2; geometric id completion for all holds; `collectConsumeWindow` removed |
