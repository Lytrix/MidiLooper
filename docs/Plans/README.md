...
| [overdub_occupy_source_view_keeps_resolver_geometry_bugfix.md](overdub_occupy_source_view_keeps_resolver_geometry_bugfix.md) | Investigation **approved**; Gates 1–4 pinned; **5A shipped** (equal-tick Off-before-On in `findNoteOffForOnIndex`); **5B** Length `6073` 551 provenance no implementation; pin [`121141`](../../captures/session_20260819_121141.log). Catalogs: [overlap-resolve](../Guides/OVERDUB_OVERLAP_RESOLVE_NOTE_EVALUATIONS.md), [ledger](../Guides/OVERDUB_LEDGER_NOTE_EVALUATIONS.md) |
