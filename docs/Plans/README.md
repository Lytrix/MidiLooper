...
| [overdub_loop_head_playback_ledger_bugfix.md](overdub_loop_head_playback_ledger_bugfix.md) | OverdubWrap skips Q16 min-length so On@0 Off@8 stays in the pass; 0-clock `atLoopStart` occupy. Native PASS; HITL open [`185831`](../../captures/session_20260818_185831.log) |
