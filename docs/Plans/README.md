...
| [overdub_wrap_playback_rebuild_before_occupy_bugfix.md](overdub_wrap_playback_rebuild_before_occupy_bugfix.md) | Wrap rebuilds merged playback on the wrap tick before occupy; pin [`152745`](../../captures/session_20260818_152745.log) `n=0 a=1 b=1` |
