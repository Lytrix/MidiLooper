...
| [overdub_present_at_tick_jit_architecture.md](overdub_present_at_tick_jit_architecture.md) | DEC-041: occupy is present-at-S JIT; full-loop `lcr,mat` is not occupy readiness; firmware not authorized |
