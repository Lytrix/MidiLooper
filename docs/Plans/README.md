...
| [overdub_occupy_on_tick_clock_catchup_bugfix.md](overdub_occupy_on_tick_clock_catchup_bugfix.md) | USB occupy ledger catch-up `(lastTick, occupyPhase]`; HITL **FAIL** [`233247`](../../captures/session_20260818_233247.log) (11 `n=0 a=1`; `n=1 a=0` met) |
