...
| [overdub_occupy_unmatched_off_ledger_investigation.md](overdub_occupy_unmatched_off_ledger_investigation.md) | Observability for interior `n=0 a=1`; FIFO Off stamping **rejected** (repo pairing is LIFO). Geometry **proven** [`090050`](../../captures/session_20260819_090050.log): nested same-pitch pair, outer entry lost at the inner NoteOn — Off identity alone cannot fix it; direction needs a design session |
