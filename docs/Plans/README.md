...
| [overdub_present_at_tick_jit_enhancement.md](overdub_present_at_tick_jit_enhancement.md) | Stage 0 answered (`MidiEvent.noteId`); write-before-emit; occupy lookup blocked |
