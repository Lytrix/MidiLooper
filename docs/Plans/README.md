...
| [overdub_occupy_active_note_ledger_cardinality_refinement.md](overdub_occupy_active_note_ledger_cardinality_refinement.md) | DEC-042 open-NoteOn ledger; occupy walks all open identities; HITL nested n/a gate open |
