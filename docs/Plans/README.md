...
| [overdub_occupy_duplicate_open_identity_bugfix.md](overdub_occupy_duplicate_open_identity_bugfix.md) | Same `noteId` already open → no second Entry; pin [`101319`](../../captures/session_20260819_101319.log) `led > n` |
