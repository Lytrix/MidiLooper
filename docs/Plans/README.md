...
| [overdub_consume_id_resolution_completeness_bugfix.md](overdub_consume_id_resolution_completeness_bugfix.md) | **Active** — Stage 1 shipped native; non-empty hold id completion + window-scan decommission; HITL gate open |
