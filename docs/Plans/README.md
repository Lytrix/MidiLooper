...
| [overdub_consume_ledger_merge_enhancement.md](overdub_consume_ledger_merge_enhancement.md) | **FROZEN** — Stage 1A/1B attribution shipped (`select` + `norowid`/`scanadd`); selection change rejected on HITL [`191133`](../../captures/session_20260819_191133.log); `norow` tagged in CURRENT_WORK § Parked |
