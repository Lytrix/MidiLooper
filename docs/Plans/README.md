...
| [overdub_occupy_merged_capture_ledger_bugfix.md](overdub_occupy_merged_capture_ledger_bugfix.md) | Playback `mergedMidiEvents` is committed-only; pin [`224719`](../../captures/session_20260818_224719.log) |
