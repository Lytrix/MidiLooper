...
| [overdub_occupy_missing_open_identity_bugfix.md](overdub_occupy_missing_open_identity_bugfix.md) | Extra covering span `n=1 a=2` whose On is not a loop-head playback NoteOn; pin [`111819`](../../captures/session_20260819_111819.log) L948; native **PASS** 1374/1374; HITL open |
