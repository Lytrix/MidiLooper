...
| [overdub_occupy_same_tick_off_before_on_bugfix.md](overdub_occupy_same_tick_off_before_on_bugfix.md) | Catch-up interval Off then On at equal tick; HITL **FAIL** [`235314`](../../captures/session_20260818_235314.log) (4 `n=0 a=1`; `n=1 a=0` met) |
