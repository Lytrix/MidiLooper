...
| [overdub_occupy_clock_same_tick_off_before_on_bugfix.md](overdub_occupy_clock_same_tick_off_before_on_bugfix.md) | Clock `rebuildPlaybackOrder` Off before On at equal phase; pin [`235314`](../../captures/session_20260818_235314.log) span-start L4811 / L4899 |
