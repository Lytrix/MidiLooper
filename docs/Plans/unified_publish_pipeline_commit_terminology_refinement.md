...
> **Vocabulary:** Commit vs Publish terms remain plan-local until promoted to [`docs/Authority/NAMING.md`](../Authority/NAMING.md). See [`architecture_naming_authority_refinement.md`](architecture_naming_authority_refinement.md) § Plan glossary index.
