...
High-level runtime map for **agents and humans**: who owns what, how data flows, and which invariants must not be broken. **Not architecture authority** — depth lives in [RuntimeArchitecture.md](../Authority/Architecture/RuntimeArchitecture.md), Guides, and OpenSpec.
...
| Need | Doc |
|------|-----|
| Layer model | [RuntimeArchitecture.md](../Authority/Architecture/RuntimeArchitecture.md) |
