...
**Kind:** bugfix  
**Date:** 2026-07-07  
**Architecture (permanent):** [RuntimeArchitecture.md](../Authority/Architecture/RuntimeArchitecture.md)
...
**Architectural framing:** consumers triggered **representation rebuild** during **playback interval** activation — violates [DerivedViews.md](../Authority/Architecture/DerivedViews.md) build policy.
...
**Historical:** This plan may be archived after HITL PASS; architecture remains in `docs/Authority/Architecture/`.
