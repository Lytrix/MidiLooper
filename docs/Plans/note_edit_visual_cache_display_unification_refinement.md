...
**Sibling (193838 mover jump):** [`note_edit_mover_wrap_length_jump_bugfix.md`](note_edit_mover_wrap_length_jump_bugfix.md) — RC1 device PASS. Do not reopen Stages 8–9.  
**Sibling (200154 note 5 restore):** [`note_edit_overlap_leave_restore_painted_span_bugfix.md`](note_edit_overlap_leave_restore_painted_span_bugfix.md) — Restore `720–2255` vs painted `720–767`.
