...
1. 5.17d **PASS**. 5.7a reserve **PASS** [`163942`](../captures/session_20260815_163942.log). **5.7b device FAIL** [`164922`](../captures/session_20260815_164922.log) `channelByNoteId` emplace 14.7 s. **5.7c** flat `{noteId, channel}` append+sort+unique; device remasure owed. Plan: [`loop_content_resolution_spans_dframe_gap_refinement.md`](loop_content_resolution_spans_dframe_gap_refinement.md).
