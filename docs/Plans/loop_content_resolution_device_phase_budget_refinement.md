...
1. 5.17d **PASS**. 5.7a reserve **PASS** [`163942`](../captures/session_20260815_163942.log). **5.7b device FAIL** [`164922`](../captures/session_20260815_164922.log). **5.7c device PASS** [`170024`](../captures/session_20260815_170024.log) `capp=12373` `csort=1779`. Pair `DFRAME` 1.277 s leftover. Plan: [`loop_content_resolution_spans_dframe_gap_refinement.md`](loop_content_resolution_spans_dframe_gap_refinement.md).
