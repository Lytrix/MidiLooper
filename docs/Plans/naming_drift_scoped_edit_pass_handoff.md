...
> **Vocabulary:** merge/materialize/memory-tier terms are canonical in [`docs/Authority/NAMING.md`](../Authority/NAMING.md). This handoff retains implementation ordering for firmware renames.
